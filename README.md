...
POST
/api/transactions
Create transaction (optional mood)

PUT
/api/transactions/:id
Update transaction (optional mood)
...
List budgets w/ progress + pace forecast
...
Totals, Pulse Score, recent transactions
...
Pulse Score, mood breakdown, category stats
